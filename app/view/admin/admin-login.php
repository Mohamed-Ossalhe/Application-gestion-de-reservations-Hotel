        ...
        <div class="log-in-form mx-auto w-1/2 h-full ">
            ...
            <form class="mt-20 flex flex-col items-center" action="../admin/LogIn" method="POST">
                ...
                <div class="flex items-center justify-between flex-col md:flex-row w-full md:w-3/5 mt-20">
                    ...
                    <button type="submit" id="submit" name="submit" class="text-white bg-black transition border-2 border-secondary-clr hover:bg-white hover:text-black hover:border-accent-clr focus:outline-none font-medium text-sm w-full sm:w-auto px-7 py-2.5 text-center order-first md:order-last mb-4 md:mb-0">Log in</button>
                </div>
            </form>
        </div>
    </div>
