...
<body class="bg-white">
    <!-- content -->
    <div class="container flex items-center justify-between h-screen md:pl-8 font-montserrat">
        <!-- col1 -->
        <div class="log-in-form mx-7 w-full md:w-2/4">
            ...
            <h2 class="text-3xl font-medium mb-5 font-wilkysta"><span class="font-montserrat">Hello! </span>Welcome to Pestana</h2>
            <form action="../client/clientSignUp" method="POST">
                ...
                <div class="grid md:grid-cols-2 md:gap-6 w-full md:w-4/5">
                    <div class="relative z-0 mb-6 w-full group">
                        <input type="text" name="first_name" id="floating_first_name" class="form-inputs block py-2.5 px-0 w-full text-sm text-secondary-clr bg-transparent border-0 border-b-2 border-color border-seco appearance-none focus:outline-none focus:ring-0 focus:border-clr peer" placeholder=" " required />
                    ...
                    <div class="relative z-0 mb-6 w-full group">
                        <input type="text" name="last_name" id="floating_last_name" class="form-inputs block py-2.5 px-0 w-full text-sm text-secondary-clr bg-transparent border-0 border-b-2 border-color border-seco appearance-none focus:outline-none focus:ring-0 focus:border-clr peer" placeholder=" " required />
                ...
                <div class="relative z-0 mb-6 w-full md:w-4/5 group">
                    <input type="tel" name="phone_n" id="floating_phone" class="form-inputs block py-2.5 px-0 w-full text-sm text-secondary-clr bg-transparent border-0 border-b-2 border-color border-seco appearance-none focus:outline-none focus:ring-0 focus:border-clr peer" placeholder=" " required />
                ...
                <div class="flex items-center justify-between flex-col md:flex-row w-full md:w-4/5">
                    ...
                    <button type="submit" name="submit" id="submit" class="text-white bg-black transition border-2 border-secondary-clr hover:bg-white hover:text-black hover:border-main-clr focus:outline-none font-medium text-sm w-full sm:w-auto px-7 py-2.5 text-center order-first md:order-last mb-4 md:mb-0">Sign Up</button>
                </div>
            </form>
        </div>
        <!-- col2 -->
        <div class="image h-full w-2/4 hidden md:block">
            ...
            <p class="capitalize font-wilkysta text-5xl text-white w-11/12 translate-x-4 -translate-y-44">
