<?php include 'includes/header.php'?>
    ...
    <div class="hero">
        <div class="container mx-auto">
            <div class="hero-text font-wilkysta text-center mb-7">
                ...
                <div class="search bg-white w-4/5 mx-auto py-4 px-3 md:translate-y-12 drop-shadow-xl">
                    <form id="search-form" class="flex items-left flex-col md:items-center md:flex-row justify-between md:gap-3" action="../home/rooms" method="POST">
                        ...
                        <div class="input-field mb-4 md:mb-0">
                            ...
                            <select id="room-type" name="room_type" class="text-secondary-clr w-full md:w-auto text-sm block p-2.5 mt-2 font-montserrat">
                        ...
                        <div date-rangepicker class="flex items-left flex-col md:items-center md:flex-row mb-4 md:mb-0">
                            <div class="relative">
                                ...
                                <input name="start_date" type="text" class="font-montserrat mt-2 text-secondary-clr text-sm block w-full p-2.5" placeholder="SELECT START DATE">
                            </div>
                            ...
                            <div class="relative">
                                ...
                                <input name="end_date" type="text" class="font-montserrat mt-2 text-secondary-clr text-sm block w-full p-2.5" placeholder="DELECT END DATE">
                            </div>
                        </div>
                        <!-- room number -->
